...
## QUESTION 1: 
Start by fitting an intercept-only model: agb = beta0 + epsilon, epsilon ∼ N (0, sigma2I) Call this model ‘fit_1’.
a. Report the value of beta0. How does it compare to the sample mean of agb?
...
sd(AGB.df$agb)
```
a) The value of beta0 is -234.938 The sample mean of agb is 410.7327 which is much higher than the value of beta0.
...
agb = beta0 + old.growth × beta1 + epsilon, epsilon ∼ N (0, sigma2I) Call this model ‘fit_2’.
...
a. Report the value of beta0. How does it compare to the sample mean of abg among new-growth forest?
> Answer: beta0 is 363.469. THe sample mean of abg among new-growth forests are the same. 
...
## Question 3
Now suppose you are interested in understanding whether or not basal area is associated with AGB. Now fit a simple linear regression of the following form: y = beta0 + basal.areabeta1 + epsilon, epsilon ∼ N (0, sigma2I). Call this model ‘fit_3’

```{r}
fit_3 <-lm(agb ~ basal_area, AGB.df)
```

a. Report the value of beta0 and interpret its meaning.
>Answer: beta0 is -113.38. This suggests that when basal area is 0, above ground biomass is -113.38. [ADD UNITS]

b. Report the value of beta1 and interpret its meaning (not in terms of a hypothesis test, but substantively).
>Answer: beta1 is 18.89, which means that as basal_area increases by 1, the above ground biomass increases by 18.89. [ADD UNITS]

c. Now define a new variable called ‘basal.area.centered’ in which you subtract the mean basal area from each observation of ‘basal.area’. Refit the above model. Report the new value of beta0 and interpret its meaning.
```{r}
colnames(AGB.df)
...
>Answer: The new value of beta0 is 410.7327, which refers to the expected above ground biomass for samples with average basal area.

d. Report the value of beta1 again and interpret its meaning (again, not in terms of a hypothesis test). Did the value of beta1 change? Why or why not?
>Answer: The new value of beta1 is 18.8948, which did not change from before. This is because we only centered the values around the mean basal area (basically shifting the datapoints to the left), but not changing the slope. 
...
## Question 4
Now suppose you wish to include both the difference between old-growth forest and new-growth forest, as well as the effect of basal area on AGB. y = beta0 + old.growthbeta1 + basal.area.centeredbeta2 + epsilon, epsilon ∼ N (0, sigma2I). Call this model ‘fit_4’.
```{r}
fit_4<- lm(agb~old.growth+basal.area.centered, AGB.df)
summary(fit_4)
```
a. What is the estimate of the intercept (beta0), and what does it represent in terms of AGB?
>Answer: The estimate of beta0 is 374.399. In terms of AGB, it represents the expected value of above ground biomass in new-growth forests with average basal area.

b. What is the estimate of beta1 and what does it represent in terms of AGB?
>Answer: The estimate of beta1 is 72.090. In terms of AGB, it represents the expected difference in above ground biomass in new vs. old growth forests with average basal area.

c. What is the estimate of beta2 and what does it represent in terms of AGB?
>Answer: The estimate of beta2 18.003. In terms of AGB, it represents that for every 1 m^2 increase in basal area, above ground biomass increases by 18. 
...
## Question 5
Now suppose you wish to test whether or not the effect of basal area differs by old growth versus new growth. To do this, construct a new covariate defined as ‘old.basal.area.centered’ = ‘old.growth’ × ‘basal.area.centered’. Now fit the following regression model: y = beta0 + old.growthbeta1 + basal.area.centeredbeta2 +
old.basal.area.centeredbeta3 + epsilon, epsilon ∼ N (0, sigma2I). Call this model ‘fit_5’.
...
a. What is the estimate of beta0 and what does it represent in terms of AGB?
>Answer: The estimate of beta0 is 373.5625. This is the expected value of AGB in new-growth forests with average basal area. 

b. What is the estimate of beta1 and what does it represent in terms of AGB?
>Answer: The estimate of beta1 is 72.1542. This is the difference in expected value of AGB in new-growth forests vs. old-growth forests with average basal area. 

c. What is the estimate of beta2 and what does it represent in terms of AGB?
>Answer: The estimate of beta2 is 16.6245. This is the expected change in AGB for each m^2 increase in basal area among new-growth forests.

d. What is the estimate of beta3 and what does it represent in terms of AGB?
>Answer: The estimate of beta3 is 2.6714. This is the adjustment to the slope for each m^2 increase in basal area among old-growth forests. 
...
Now fit the following model: y = beta0 + cabeta1 + cobeta2 + mebeta3 + ncbeta4 + epsilon, epsilon ∼ N (0, sigma2I) Call this model ‘fit_6’.
```{r states}
colnames(AGB.df)
head(AGB.df$state)
AGB.df<- AGB.df%>%
...
a. What is the estimate of the beta0 and what does it represent in terms of AGB?
>Answer: The estimate of beta0 is 411.75 and this is the expected AGB in WA.

b. What is the estimate of beta1 and what does it represent in terms of AGB?
>Answer: The estimate of beta1 is 16.34 and this is the difference in expected AGB between WA and CA, holding all else constant.

c. What is the estimate of beta2 and what does it represent in terms of AGB?
>Answer: The estimate of beta2 is -32.11 and this is the difference in expected AGB between WA and CO, holding all else constant. 

d. What is the estimate of beta3 and what does it represent in terms of AGB?
>Answer: The estimate of beta3 is 24.54 and this is the difference in expected AGB between WA and ME, holding all else constant.

e. What is the estimate of beta4 and what does it represent in terms of AGB?
>Answer: The estimate of beta4 is -18.35 and this is the difference in expected AGB between WA and NC, holding all else constant.
