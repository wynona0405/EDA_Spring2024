...
#1 
library(tidyverse);library(lubridate);library(viridis);library(here);library(rvest);library(dataRetrieval);library(tidycensus);library(ggplot2);library(dplyr)
...
#I'm confused about the class for this. Should it be numeric or vector or strings? Right now it is character, even though I try as.numeric or toString()
...
view(max_daily_withdrawals_Asheville_2015_df)

max_daily_withdrawals_Asheville_Durham_2015_df<-bind_rows(max_daily_withdrawals_Asheville_2015_df,max_daily_withdrawals_Durham_2015_df)

max_daily_withdrawals_Asheville_Durham_2015_df

ggplot(max_daily_withdrawals_Asheville_Durham_2015_df, aes(x=Date, y=Max_Day_Use, color=Water_System_Name))+geom_point()+geom_line()+labs(title="Max Day Use for Asheville vs. Durham", y="Max Day Use (MGD)")
...
ggplot(water_df_2010_to_2021_v2,aes(y = Max_Day_Use, x=Date)) +
  geom_line()+geom_smooth(method="lm")+labs(title="Max Day Use for Asheville from 2010 to 2021", y="Max Day Use (MGD)")
...
water_df_2010_to_2011_manual<-bind_rows(Asheville_2010, Asheville_2011,Asheville_2012, Asheville_2013, Asheville_2014, Asheville_2015, Asheville_2016, Asheville_2017, Asheville_2018, Asheville_2019, Asheville_2020, Asheville_2021)
...
> Answer:
> Looking at the plot, the water usage in Asheville seems to be increasing over time. 
