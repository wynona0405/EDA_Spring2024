...
vector2 <- c("Wynona","Ariane","Nikhil")
...
```{r DataExercise-1a}
high_temp_NC <- c(52, 34, 41, 49, 56, 65, 69, 69, 66, 62)
low_temp_NC <- c(21, 18, 18, 29, 45, 57, 58, 58, 51, 41)
temp_forecast <- data.frame(high_temp_NC, low_temp_NC)
temp_forecast
```
