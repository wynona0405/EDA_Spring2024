...
-   Control how *code* appears in knit output: code chunk settings
-   Control how *text* appears in knit output:markdown techniques
-   Understand the knitting process and how it converts Rmd to PDF, HTML, etc.
